...
public class replace_UTF8 {
	static HashMap<Character, String> char_map = new HashMap<Character, String>();
	static {
		...
		char_map.put(new Character('\u0150'), new String("O")); // Decimal=330 (Latin Capital Letter O With Double
																// Acute)
		...
		char_map.put(new Character('\u01be'), new String("t")); // Decimal=446 (Latin Letter Inverted Glottal Stop With
																// Stroke)
	...
	public static String ReplaceLooklike(String input) throws IOException {
