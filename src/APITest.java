...
/*
 * Some simple tests to explore the APIs functionality and make sure everything is working 
 * as it should.
 */
public class APITest {
	...
	public static void main(String[] args) throws Exception {
		...
		List<Result> resultList = api.processCitationsFromString
				("US transverse view of CFV shows an echogenic intraluminal non-occlusive thrombus in the dependent portion of the CFV, which is the larger vessel to the right.");
				//api.processCitationsFromString
